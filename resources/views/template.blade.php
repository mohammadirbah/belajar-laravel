...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container">
                <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
                    <p class="col-md-4 mb-0 text-body-secondary">&copy; 2024 Mohammad Irbah</p>
    ...
    <script src="{{ asset('sb/js/chart-area-demo.js') }}"></script>
    <script src="{{ asset('sb/js/chart-pie-demo.js') }}"></script>
